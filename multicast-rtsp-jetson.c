...
main (int argc, char *argv[])
{
  ...
  gst_rtsp_media_factory_set_launch (factory1enc, "( "
      ...
      "nvvidconv ! video/x-raw(memory:NVMM),format=NV12,width=640,height=480,framerate=1/1 ! queue ! nvv4l2h264enc maxperf-enable=1 bitrate=8000000 ! "
  ...
  gst_rtsp_media_factory_set_launch (factory5enc, "( "
      ...
      "nvvidconv ! video/x-raw(memory:NVMM),format=NV12,width=640,height=480,framerate=5/1 ! queue ! nvv4l2h264enc maxperf-enable=1 bitrate=8000000 ! "
      "rtph264pay name=pay0 pt=96 " ")");
  ...
  gst_rtsp_media_factory_set_launch (factory10enc, "( "
      ...
      "nvvidconv ! video/x-raw(memory:NVMM),format=NV12,width=640,height=480,framerate=10/1 ! queue ! nvv4l2h264enc maxperf-enable=1 bitrate=8000000 ! "
      "rtph264pay name=pay0 pt=96 " ")");
  ...
  gst_rtsp_media_factory_set_launch (factory30enc, "( "
      ...
      "nvvidconv ! video/x-raw(memory:NVMM),format=NV12,width=640,height=480,framerate=30/1 ! queue ! nvv4l2h264enc maxperf-enable=1 bitrate=8000000 ! "
      "rtph264pay name=pay0 pt=96 " ")");
